...
type FakeServiceProvider struct {
	...
	UpgradeStub        func(context.Context, *varcontext.VarContext, map[string]*varcontext.VarContext) (models.ServiceInstanceDetails, error)
	upgradeMutex       sync.RWMutex
	upgradeArgsForCall []struct {
		arg1 context.Context
		arg2 *varcontext.VarContext
		arg3 map[string]*varcontext.VarContext
	}
...
func (fake *FakeServiceProvider) Upgrade(arg1 context.Context, arg2 *varcontext.VarContext, arg3 map[string]*varcontext.VarContext) (models.ServiceInstanceDetails, error) {
...
func (fake *FakeServiceProvider) UpgradeCalls(stub func(context.Context, *varcontext.VarContext, map[string]*varcontext.VarContext) (models.ServiceInstanceDetails, error)) {
	fake.upgradeMutex.Lock()
	defer fake.upgradeMutex.Unlock()
	fake.UpgradeStub = stub
}

func (fake *FakeServiceProvider) UpgradeArgsForCall(i int) (context.Context, *varcontext.VarContext, map[string]*varcontext.VarContext) {
	fake.upgradeMutex.RLock()
	defer fake.upgradeMutex.RUnlock()
