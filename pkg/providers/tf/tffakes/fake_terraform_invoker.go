...
type FakeTerraformInvoker struct {
	ApplyStub        func(context.Context, tf.Workspace) error
	...
	DestroyStub        func(context.Context, tf.Workspace) error
	...
	ImportStub        func(context.Context, tf.Workspace, map[string]string) error
	...
	PlanStub        func(context.Context, tf.Workspace) (wrapper.ExecutionOutput, error)
	...
	ShowStub        func(context.Context, tf.Workspace) (string, error)
...
func (fake *FakeTerraformInvoker) Apply(arg1 context.Context, arg2 tf.Workspace) error {
...
func (fake *FakeTerraformInvoker) ApplyCalls(stub func(context.Context, tf.Workspace) error) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *FakeTerraformInvoker) ApplyArgsForCall(i int) (context.Context, tf.Workspace) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *FakeTerraformInvoker) Destroy(arg1 context.Context, arg2 tf.Workspace) error {
...
func (fake *FakeTerraformInvoker) DestroyCalls(stub func(context.Context, tf.Workspace) error) {
	fake.destroyMutex.Lock()
	defer fake.destroyMutex.Unlock()
	fake.DestroyStub = stub
}

func (fake *FakeTerraformInvoker) DestroyArgsForCall(i int) (context.Context, tf.Workspace) {
	fake.destroyMutex.RLock()
	defer fake.destroyMutex.RUnlock()
...
func (fake *FakeTerraformInvoker) Import(arg1 context.Context, arg2 tf.Workspace, arg3 map[string]string) error {
...
func (fake *FakeTerraformInvoker) ImportCalls(stub func(context.Context, tf.Workspace, map[string]string) error) {
	fake.importMutex.Lock()
	defer fake.importMutex.Unlock()
	fake.ImportStub = stub
}

func (fake *FakeTerraformInvoker) ImportArgsForCall(i int) (context.Context, tf.Workspace, map[string]string) {
	fake.importMutex.RLock()
	defer fake.importMutex.RUnlock()
...
func (fake *FakeTerraformInvoker) Plan(arg1 context.Context, arg2 tf.Workspace) (wrapper.ExecutionOutput, error) {
	fake.planMutex.Lock()
...
func (fake *FakeTerraformInvoker) PlanCalls(stub func(context.Context, tf.Workspace) (wrapper.ExecutionOutput, error)) {
	fake.planMutex.Lock()
	defer fake.planMutex.Unlock()
	fake.PlanStub = stub
}

func (fake *FakeTerraformInvoker) PlanArgsForCall(i int) (context.Context, tf.Workspace) {
	fake.planMutex.RLock()
	defer fake.planMutex.RUnlock()
...
func (fake *FakeTerraformInvoker) PlanReturns(result1 wrapper.ExecutionOutput, result2 error) {
	fake.planMutex.Lock()
	defer fake.planMutex.Unlock()
	fake.PlanStub = nil
...
func (fake *FakeTerraformInvoker) PlanReturnsOnCall(i int, result1 wrapper.ExecutionOutput, result2 error) {
	fake.planMutex.Lock()
	defer fake.planMutex.Unlock()
	fake.PlanStub = nil
...
func (fake *FakeTerraformInvoker) Show(arg1 context.Context, arg2 tf.Workspace) (string, error) {
	fake.showMutex.Lock()
...
func (fake *FakeTerraformInvoker) ShowCalls(stub func(context.Context, tf.Workspace) (string, error)) {
	fake.showMutex.Lock()
	defer fake.showMutex.Unlock()
	fake.ShowStub = stub
}

func (fake *FakeTerraformInvoker) ShowArgsForCall(i int) (context.Context, tf.Workspace) {
	fake.showMutex.RLock()
	defer fake.showMutex.RUnlock()
...
var _ tf.TerraformInvoker = new(FakeTerraformInvoker)
