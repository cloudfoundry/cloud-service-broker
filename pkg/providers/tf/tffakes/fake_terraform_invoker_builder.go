...
type FakeTerraformInvokerBuilder struct {
	VersionedTerraformInvokerStub        func(*version.Version) tf.TerraformInvoker
...
func (fake *FakeTerraformInvokerBuilder) VersionedTerraformInvoker(arg1 *version.Version) tf.TerraformInvoker {
...
func (fake *FakeTerraformInvokerBuilder) VersionedTerraformInvokerCalls(stub func(*version.Version) tf.TerraformInvoker) {
	fake.versionedTerraformInvokerMutex.Lock()
...
func (fake *FakeTerraformInvokerBuilder) VersionedTerraformInvokerReturns(result1 tf.TerraformInvoker) {
	fake.versionedTerraformInvokerMutex.Lock()
	defer fake.versionedTerraformInvokerMutex.Unlock()
...
func (fake *FakeTerraformInvokerBuilder) VersionedTerraformInvokerReturnsOnCall(i int, result1 tf.TerraformInvoker) {
	fake.versionedTerraformInvokerMutex.Lock()
	defer fake.versionedTerraformInvokerMutex.Unlock()
	fake.VersionedTerraformInvokerStub = nil
...
var _ tf.TerraformInvokerBuilder = new(FakeTerraformInvokerBuilder)
