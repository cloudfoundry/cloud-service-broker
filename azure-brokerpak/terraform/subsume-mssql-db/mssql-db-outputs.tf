...
output status {value = format("subsumed db %s (id: %s) on server %s (id: %s) edition: %s, service_objective: %s, URL: https://portal.azure.com/#@%s/resource%s",
                              ...
                              azurerm_sql_database.azure_sql_db.edition, azurerm_sql_database.azure_sql_db.requested_service_objective_name,
                              var.azure_tenant_id, azurerm_sql_database.azure_sql_db.id)}