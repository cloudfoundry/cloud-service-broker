...
variable server_admin_username { type = string }
variable server_admin_password { type = string }
variable server_resource_group { type = string }
...
output "username" {value = var.server_admin_username}
output "password" {value = var.server_admin_password}
