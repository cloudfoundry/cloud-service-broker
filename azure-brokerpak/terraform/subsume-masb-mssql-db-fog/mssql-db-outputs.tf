...
output sqldbName {value = azurerm_sql_database.primary_db.name}
...
output name {value = azurerm_sql_database.primary_db.name}
...
output status {value = format("created failover group %s (id: %s), primary db %s (id: %s) on server %s (id: %s), secondary db %s (id: %s/databases/%s) on server %s (id: %s) URL: https://portal.azure.com/#@%s/resource%s/failoverGroup",
                                              ...
                                              azurerm_sql_database.primary_db.name, azurerm_sql_database.primary_db.id,
                                              data.azurerm_sql_server.primary_sql_db_server.name, data.azurerm_sql_server.primary_sql_db_server.id,
                                              azurerm_sql_database.primary_db.name, data.azurerm_sql_server.secondary_sql_db_server.id, azurerm_sql_database.primary_db.name,
